...
fun ProfilesScreen(
    ...
    var newVersionId by remember(homeState.selectedVersionId) { mutableStateOf(homeState.selectedVersionId) }
                        ...
                        if (newProfileName.isNotBlank()) {
                            viewModel.container.appScope.launch {
                                viewModel.container.profileManager.createProfile(
                                    ...
                                    javaVersion = viewModel.javaRequirementForVersion(newVersionId),
